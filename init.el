...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (robot-mode ws-butler gruvbox-theme csharp-mode protobuf-mode helm-swoop helm expand-region projectile backup-each-save magit lua-mode yaml-mode git-timemachine poet-theme fill-column-indicator writegood-mode use-package ample-theme solarized-theme ag exec-path-from-shell markdown-mode rainbow-mode highlight-symbol)))
