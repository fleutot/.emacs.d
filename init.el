...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ggtags helm-ag helm-swoop backup-each-save lua-mode yaml-mode projectile git-timemachine poet-theme fill-column-indicator writegood-mode use-package ample-theme solarized-theme expand-region haskell-mode ag dtrt-indent blank-mode exec-path-from-shell markdown-mode rainbow-mode highlight-symbol)))
