...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (expand-region haskell-mode projectile ag transient magit dtrt-indent blank-mode exec-path-from-shell yaml-mode markdown-mode rainbow-mode highlight-symbol ack)))
