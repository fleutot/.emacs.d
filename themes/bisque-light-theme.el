...
;;; Code:
(deftheme bisque-light "The light version of the bisque color theme, based on zenburn")
...
(let ((class '((class color) (min-colors 89)))
      ...
      (bisque-cyan "#93e0e3")
      (bisque-blue+1 "#9ce0f3")
      (bisque-blue "#8cd0e3")
      (bisque-blue-1 "#7cc0d3")
...
;;; bisque-light-theme.el ends here
