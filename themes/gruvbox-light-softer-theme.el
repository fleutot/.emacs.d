;;; gruvbox-lighter-soft-theme.el --- A retro-groove colour theme for Emacs -*- lexical-binding: t -*-
;;; Modified by Gauthier Östervall for an even softer version.
...
;;; TODO: make a softer (lower contrast) palette
  ...
  (gruvbox-light0          "#686868" "#666666")
  (gruvbox-light1          "#7c7876" "#3a3a3a")
  (gruvbox-light2          "#908985" "#5e5e5e")
  (gruvbox-light3          "#a69c94" "#a2a2a2")
  (gruvbox-light4          "#bcafa4" "#b6b6b6")
...
;  (gruvbox-light4          "#7c6f64" "#767676")
  ...
  (gruvbox-bright_green    "#79940e" "#878700")
  (gruvbox-bright_yellow   "#b57614" "#af8700")
  (gruvbox-bright_blue     "#278698" "#005f87")
  ...
  (gruvbox-faded_green     "#98b71a" "#afaf00")
  (gruvbox-faded_yellow    "#d79921" "#ffaf00")
  (gruvbox-faded_blue      "#65a5a8" "#87afaf")
 ...
 (custom-theme-set-variables 'gruvbox-light-softer
...
(provide-theme 'gruvbox-light-softer)

;; Local Variables:
;; eval: (when (fboundp 'rainbow-mode) (rainbow-mode +1))
;; End:

;;; gruvbox-light-softer-theme.el ends here
