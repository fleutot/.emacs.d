;;; bisque-darker-theme.el --- Based on:
...
;;; Code:
(deftheme bisque-darker "The bisque color theme but darker, based on zenburn")
...
(let ((class '((class color) (min-colors 89)))
      ...
      (bisque-green-1 "#4f6f4f")
      (bisque-green "#6f8f6f")
      (bisque-green+1 "#7fa27f")
      (bisque-green+2 "#8fb58f")
      (bisque-green+3 "#9fc89f")
      (bisque-green+4 "#afdbaf")
      (bisque-cyan "#93e0e3")
      (bisque-blue+1 "#84afe3")
      (bisque-blue "#7cc0d3")
      (bisque-blue-1 "#6ca8bb")
      (bisque-blue-2 "#5c90a3")
      (bisque-blue-3 "#4c788b")
      (bisque-blue-4 "#3c6073")
      (bisque-blue-5 "#265060")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-type-face ((t (:foreground ,bisque-blue-2))))
   ...
   `(org-level-3 ((t (:foreground ,bisque-blue))))
   `(org-level-4 ((t (:foreground ,bisque-yellow-2))))
   `(org-level-5 ((t (:foreground ,bisque-blue-2))))
   `(org-level-6 ((t (:foreground ,bisque-green))))
...
;;; bisque-darker-theme.el ends here
